...
public class SchedulerHints {
   ...
   public static class Builder {
      ...
      public SchedulerHints build() {
         return new SchedulerHints(serverGroup);
      }
   ...
   protected SchedulerHints(@Nullable String serverGroup) {
      this.serverGroup = serverGroup;
   }
   ...
   @Override
   public int hashCode() {
      return Objects.hashCode(serverGroup);
   }
   ...
   public boolean equals(Object obj) {
      ...
      return Objects.equal(this.serverGroup, that.serverGroup);
   }
   
   protected ToStringHelper string() {
      return Objects.toStringHelper(this).add("group", serverGroup);
   }
