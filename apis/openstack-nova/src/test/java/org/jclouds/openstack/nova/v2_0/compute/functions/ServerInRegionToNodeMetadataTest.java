...
public class ServerInRegionToNodeMetadataTest {
   ...
   public void testAlternateAccessIPs() {
      ...
      assertEquals(convertedNodeMetadata.getPrivateAddresses(),
              ImmutableSet.of("10.176.42.16","fd00::1:ff4e:3e:9:e"));

      assertNotNull(convertedNodeMetadata.getPublicAddresses());
      // note jclouds doesn't yet support ipv6 b/c not tested yet
      assertEquals(convertedNodeMetadata.getPublicAddresses(),
              ImmutableSet.of("67.23.10.132", "67.23.10.131", "76.32.1.231"));
   }
